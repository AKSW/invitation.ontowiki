...
class InvitationController extends OntoWiki_Controller_Component
{
    ...
    public function submitAction ()
    {
        ...
        $invitationCount = InvitationDB::invitationCount(
            $modelUri, $accountMail, intval($this->_privateConfig->invitationlimittime)
        );
        ...
        foreach ($receiverList as $receiver) {
            ...
            try {
                ...
                InvitationDB::addInvitation(
                    $modelUri, $invitationCode, $accountMail, $receiver, $resourceModel->getModelUri(), $resource
                );
