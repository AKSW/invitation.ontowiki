<?PHP
    ...
    class InvitationDB {
        ...
        private static function createModel($modelUri) {
            ...
            $store->addStatement($modelUri,
                                 'Invitation',
                                 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type', 
                                 array('value' => 'http://www.w3.org/2002/07/owl#Class','type' => 'uri'));


            $model->setOption($config->sysont->properties->hidden, array(array(
                'value'    => 'true',
                'type'     => 'literal',
        ...
        /**
         * This function checks whether there is already an invitation from the sender to the receiver for the instanceUri
         * @param modelUri The uri to the ontology
        ...
        public static function wasInvited($modelUri, $sender, $receiver, $instanceUri) {
            ...
            $query->setProloguePart('SELECT ?instanceUri')
                  ->setWherePart('WHERE {'.
                                 ...
                                 '?resourceUri <http://rdfs.org/sioc/ns#topic> ?instanceUri . FILTER (?instanceUri = <'.$instanceUri.'>) }')
        ...
        public static function invitationCount($modelUri, $sender, $time) {
            ...
            foreach($queryData as $data) {
                if(intval($data['time']) > $allowedTime) $result++;
            }
        ...
        public static function generateCode($modelUri) {
            ...
            do { //Repeat while code already used
